...
String treeGroupJson =
    '{"id":"1","name":"Cítricos","description":"Grupo cítricos"}';

void main() {
  test("Test convertion of json to TreeGroupModel", () {
    TreeGroupModel treeGroup =
        TreeGroupModel.fromJson(jsonDecode(treeGroupJson));
  ...
  test("Test convertion of TreeGroupModel to Json", () {
    TreeGroupModel treeGroup = const TreeGroupModel(
        id: "1", name: "Cítricos", description: "Grupo cítricos");
