...
String treeJson = '{"id":"1","description":"macieira","plantedIn":"2022-05-25T15:59:53.000","specie":{"id":"0101","description":"Arvore de Maçã"},"treeGroup":{"id":"1","name":"Cítricos","description":"Grupo cítricos"}}';
...
void main () {
  ...
  test("Test convertion of TreeModel to Json", () {
    TreeModel tree = TreeModel(id: "1", description: "macieira", plantedIn: DateTime.parse("2022-05-25T15:59:53.000"), specie: SpecieModel(id: "0101", description: "Arvore de Maçã"), treeGroup:  TreeGroupModel(id: "1", name: "Cítricos", description: "Grupo cítricos"));
